        ...
        <>
            <header className="AdminDashboardheader">
                <div className="Main-AdminDashboardheader">
                    ...
                    <button className="AdminDashboardheader-menu-toggle" onClick={toggleMenu}>
                        <MenuIcon />
                    </button>
                    ...
                    */}
                    <div 
                        className={`AdminDashboardheader-btn-box ${isMenuOpen ? 'open' : ''}`}
                    >
                        <div className="AdminDashboardheader-icon" onClick={() => { navigate('/'); setIsMenuOpen(false); }}><Home_svg /></div>
                        <div className="AdminDashboardheader-icon" onClick={() => { navigate('/discussions'); setIsMenuOpen(false); }}><Chart_svg /></div>
                        <div className="AdminDashboardheader-icon" onClick={() => { navigate('/chat'); setIsMenuOpen(false); }}><Message_svg /></div>
